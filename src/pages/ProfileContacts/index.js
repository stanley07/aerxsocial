        ...
        <aside className="md:hidden sm:hidden w-[18%]">
          <div className="">
            <Column className="bg-gray_901 flex flex-col items-center justify-start pt-[4px] w-[100%]">
              ...
              />
              <Text
                className="font-semibold mt-[2px] text-white_A700 tracking-ls028 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                as="h4"
                variant="h4"
              >
                Create new circle
              </Text>
              <Stack className="h-[107px] max-w-[107px] ml-[auto] mr-[auto] sm:mt-[10px] md:mt-[13px] mt-[20px] sm:pl-[15px] sm:pr-[15px] relative w-[100%] sm:w-[56px] md:w-[73px]">
                <Img
                  src="images/img_checkmark.svg"
                  className="absolute h-[24px] left-[16%] max-w-[100%] top-[16%] sm:w-[12px] md:w-[16px] w-[24px]"
                  alt="checkmark"
                />
                <Column className="absolute bg-white_A700_0c flex flex-col h-[107px] sm:h-[57px] md:h-[74px] items-center justify-start sm:px-[4px] md:px-[5px] px-[8px] rounded-radius15 w-[100%]">
                  <Column className="flex flex-col sm:h-[49px] md:h-[63px] h-[91px] items-center justify-start sm:w-[48px] md:w-[62px] w-[91px]">
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                      <div className="bg-white_A700_0c sm:h-[23px] md:h-[29px] h-[42px] rounded-radius50 sm:w-[22px] md:w-[28px] w-[42px]"></div>
                      <Img
              ...
              <Button
                className="cursor-pointer font-medium min-w-[91%] md:mt-[11px] mt-[16px] sm:mt-[8px] text-[14px] text-center text-white_A700 tracking-ls028 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
                size="lg"
                variant="FillGray903"
              >
                Conference 2023
              </Button>
              <Stack className="h-[454px] sm:mt-[12px] md:mt-[16px] mt-[24px] relative w-[100%]">
                <Column className="absolute flex flex-col justify-end left-[5%] sm:mx-[0] sm:px-[0] right-[2%] sm:w-[100%] w-[94%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end md:ml-[52px] ml-[76px] md:mr-[4px] mr-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[65%]">
                    <Text
                    ...
                    <Button
                      className="flex sm:h-[13px] md:h-[17px] h-[24px] items-center justify-center sm:ml-[27px] md:ml-[35px] ml-[51px] rounded-radius50 sm:w-[12px] md:w-[16px] w-[24px]"
                      size="smIcn"
                  ...
                  <Column className="flex flex-col items-center justify-end sm:mt-[4px] md:mt-[5px] mt-[8px] w-[100%]">
                    <Row className="bg-gray_903 flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] p-[10px] sm:p-[5px] md:p-[6px] rounded-radius10 sm:w-[100%] w-[97%]">
                      <Img
                      ...
                      />
                      <Text
                        className="flex-grow font-normal sm:ml-[3px] md:ml-[4px] ml-[6px] not-italic text-white_A700_75"
                        as="h4"
                        variant="h4"
                      >
                        Search
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-evenly md:mt-[11px] mt-[16px] sm:mt-[8px] w-[100%]">
                            ...
                            <Column className="flex flex-col items-center justify-start w-[100%]">
                              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between w-[100%]">
                                <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[22%]">
                                  <Stack className="h-[48px] relative sm:w-[25px] md:w-[33px] w-[48px]">
                                    <Img
                                      src="images/img_squircle_48X48.png"
                                      className="absolute sm:h-[26px] md:h-[34px] h-[48px] rounded-radius50 w-[100%]"
                                      alt="Squircle Four"
                                    />
                                    <Img
                                  ...
                                  <Text
                                    className="font-medium sm:mt-[4px] md:mt-[5px] mt-[8px] text-indigo_A200 w-[auto]"
                                    as="h5"
                                    variant="h5"
                                  >
                                    Steven
                              ...
                              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between mt-[11px] sm:mt-[5px] md:mt-[7px] w-[100%]">
                                <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[22%]">
                                  ...
                                  <Text
                                    className="font-medium mt-[10px] sm:mt-[5px] md:mt-[6px] text-indigo_A200 w-[auto]"
                                    as="h5"
                                    variant="h5"
                                  >
                                    Marry
                              ...
                              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between mt-[11px] sm:mt-[5px] md:mt-[7px] w-[100%]">
                                <Column className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[22%]">
                                  ...
                                  <Text
                                    className="font-medium sm:mt-[3px] md:mt-[4px] mt-[6px] text-indigo_A200 w-[auto]"
                                    as="h5"
                                    variant="h5"
                                  >
                                    Lian
                                ...
                                <Column className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[22%]">
                                  ...
                                  />
                                  <Text
                                    className="font-medium sm:mt-[3px] md:mt-[4px] mt-[6px] text-white_A700 w-[auto]"
                                    as="h5"
                                    variant="h5"
                                  >
                                    Steven
                      ...
                      <Line className="bg-indigo_A200 h-[109px] sm:h-[59px] md:h-[76px] sm:mb-[472px] md:mb-[610px] mb-[887px] rounded-radius1 w-[2px]" />
                    </Row>
                  </Column>
                </Column>
                <Column className="absolute flex flex-col items-center justify-start w-[100%]">
                  <div className="bg-gradient  sm:h-[26px] md:h-[34px] h-[48px] w-[100%]"></div>
                  <Column className="bg-gray_901 flex flex-col items-center justify-start p-[12px] sm:p-[6px] md:p-[8px] w-[100%]">
                    <Button
                      className="cursor-pointer font-semibold min-w-[100%] text-[14px] text-center text-white_A700 tracking-ls028 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
                      size="lg"
