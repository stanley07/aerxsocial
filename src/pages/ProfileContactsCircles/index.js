...
const ProfileContactsCirclesPage = () => {
    ...
    <>
      <Row className="bg-black_900 flex flex-row md:flex-wrap sm:flex-wrap font-poppins items-center mx-[auto] sm:pr-[15px] md:pr-[16px] pr-[24px] w-[100%]">
        <aside className="md:hidden sm:hidden w-[18%]">
          <div className="">
            <Column className="bg-gray_901 flex flex-col items-center justify-start p-[4px] w-[100%]">
              <Img
                src="images/img_signal.svg"
                className="md:h-[12px] h-[16px] sm:h-[9px] max-w-[16px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%] md:w-[11px] sm:w-[8px]"
                alt="signal"
              />
              <Column className="flex flex-col items-center justify-start max-w-[226px] sm:mb-[148px] md:mb-[191px] mb-[278px] ml-[auto] mr-[auto] md:mt-[11px] mt-[17px] sm:mt-[9px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
                ...
                <Row className="bg-gray_903 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end md:mt-[11px] mt-[16px] sm:mt-[8px] p-[4px] rounded-radius8 w-[100%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[19%]">
                    <Img
                  ...
                  <Button
                    className="flex items-center justify-center md:ml-[23px] min-w-[50%] ml-[34px] sm:ml-[18px] text-center w-[max-content]"
                    leftIcon={
                      <Img
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[12px] md:mt-[16px] mt-[24px] w-[100%]">
                  <Column className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[48%]">
                    <Column className="bg-white_A700_0c flex flex-col h-[107px] sm:h-[57px] md:h-[74px] items-center justify-start sm:px-[4px] md:px-[5px] px-[8px] rounded-radius15 w-[100%]">
                      <Column className="flex flex-col sm:h-[49px] md:h-[63px] h-[91px] items-center justify-start sm:w-[48px] md:w-[62px] w-[91px]">
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                          <Stack className="h-[42px] relative sm:w-[22px] md:w-[28px] w-[42px]">
                            <Img
                              ...
                              alt="location"
                            />
                            <div className="absolute bg-white_A700_0c sm:h-[23px] md:h-[29px] h-[42px] rounded-radius50 sm:w-[22px] md:w-[28px] w-[42px]"></div>
                          </Stack>
                          <Img
                    ...
                    <Text
                      className="font-medium mt-[11px] sm:mt-[5px] md:mt-[7px] text-white_A700 w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Family
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[12px] md:mt-[16px] mt-[24px] w-[100%]">
                    ...
                    <Column className="bg-white_A700_0c flex flex-col h-[107px] sm:h-[57px] md:h-[74px] items-center justify-start sm:px-[4px] md:px-[5px] px-[8px] rounded-radius15 w-[100%]">
                      <Column className="flex flex-col sm:h-[49px] md:h-[63px] h-[91px] items-center justify-start sm:w-[48px] md:w-[62px] w-[91px]">
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                          ...
                          >
                            <Img
                              src="images/img_trash_42X42.svg"
                              className="h-[24px] sm:h-[13px] md:h-[17px] flex items-center justify-center"
                              alt="trash"
                            />
                          </Button>
                  ...
                  <Column className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[48%]">
                    <Column className="bg-white_A700_07 flex flex-col h-[107px] sm:h-[57px] md:h-[74px] items-center justify-end sm:p-[15px] md:px-[22px] px-[33px] rounded-radius15 w-[100%]">
                      <Button
                        className="flex sm:h-[22px] md:h-[28px] h-[40px] items-center justify-center mt-[1px] sm:w-[21px] md:w-[27px] w-[40px]"
                    ...
                    <Text
                      className="font-medium mt-[10px] sm:mt-[5px] md:mt-[6px] text-white_A700_75 w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      + Add circles
...
export default ProfileContactsCirclesPage;
