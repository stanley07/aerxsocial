    ...
    <>
      <Row className="bg-black_900 flex flex-row md:flex-wrap sm:flex-wrap font-poppins items-center mx-[auto] sm:pr-[15px] md:pr-[16px] pr-[24px] w-[100%]">
        <aside className="md:hidden sm:hidden w-[18%]">
          <div className="">
            <Column className="bg-gray_901 flex flex-col items-end justify-start pt-[4px] w-[100%]">
              <Img
              ...
              />
              <Text
                className="font-medium mt-[10px] sm:mt-[5px] md:mt-[6px] text-white_A700 tracking-ls028 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                as="h4"
                variant="h4"
              >
                Selected: 4
              </Text>
              <Column className="flex flex-col justify-start max-w-[238px] ml-[auto] mr-[auto] mt-[12px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                  <Button
                    className="flex items-center justify-center min-w-[33%] text-center w-[max-content]"
                    rightIcon={
                      <Img
                        src="images/img_close_12X12.svg"
                  ...
                  <Button
                    className="flex items-center justify-center min-w-[27%] text-center w-[max-content]"
                    rightIcon={
                      <Img
                        src="images/img_close_12X12.svg"
                        className="ml-[4px] text-center"
                ...
                <Column className="bg-gray_900_a2 flex flex-col justify-start mt-[12px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] p-[12px] sm:p-[6px] md:p-[8px] rounded-radius10 sm:w-[100%] w-[95%]">
              ...
              <Stack className="h-[551px] md:mt-[11px] mt-[16px] sm:mt-[8px] relative w-[100%]">
                <Column className="absolute flex flex-col inset-x-[5%] items-center justify-end sm:mx-[0] sm:px-[0] sm:w-[100%] w-[91%]">
                ...
                <div className="absolute bg-gradient  bottom-[12%] sm:h-[26px] md:h-[34px] h-[48px] w-[100%]"></div>
...
export default ProfilePinnedSelectPage;
