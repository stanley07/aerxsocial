    ...
    <>
      <Row className="bg-black_900 flex flex-row md:flex-wrap sm:flex-wrap font-poppins items-center mx-[auto] sm:pr-[15px] md:pr-[16px] pr-[24px] w-[100%]">
        <aside className="md:hidden sm:hidden w-[18%]">
          <div className="">
            <Column className="bg-gray_901 flex flex-col items-center justify-start pt-[4px] px-[4px] w-[100%]">
              <Img
                src="images/img_signal.svg"
                className="md:h-[12px] h-[16px] sm:h-[9px] max-w-[16px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%] md:w-[11px] sm:w-[8px]"
                alt="signal"
              />
              <Column className="flex flex-col items-center justify-start max-w-[233px] ml-[auto] mr-[auto] mt-[2px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[97%]">
                  ...
                  />
                  <Text
                    className="font-semibold text-white_A700 tracking-ls028 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                    as="h4"
                    variant="h4"
                  >
                    Contacts
                ...
                <Row className="bg-gray_903 flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[4px] md:mt-[6px] mt-[9px] sm:mx-[0] p-[4px] rounded-radius8 sm:w-[100%] w-[97%]">
                  <Button
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center md:ml-[15px] ml-[23px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[30%]">
                    <Img
                    ...
                    />
                    <Text
                      className="flex-grow font-normal sm:ml-[3px] md:ml-[4px] ml-[7px] not-italic text-white_A700_75"
                      as="h5"
                      variant="h5"
                    >
                      Circles
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-evenly md:mt-[11px] mt-[16px] sm:mt-[8px] w-[100%]">
                  <Column className="flex flex-col items-center justify-end sm:mx-[0] sm:px-[0] sm:w-[100%] w-[97%]">
                    ...
                    <Column className="flex flex-col items-center justify-end mt-[12px] sm:mt-[6px] md:mt-[8px] w-[100%]">
                      <Column className="flex flex-col items-center justify-start w-[100%]">
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between w-[100%]">
                          <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[22%]">
                            <Img
                  ...
                  <Line className="bg-indigo_A200 h-[109px] sm:h-[59px] md:h-[76px] sm:mb-[260px] md:mb-[337px] mb-[490px] rounded-radius1 w-[2px]" />
                </Row>
              </Column>
            </Column>
          </div>
...
export default ProfileContactsOnePage;
