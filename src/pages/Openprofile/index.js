        ...
        <aside className="md:hidden sm:hidden w-[20%]">
          <div className="">
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly w-[100%]">
              <Column className="flex flex-col items-center max-w-[250px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
                <Stack className="bg-gray_900 h-[700px] relative w-[100%]">
                  <Stack className="absolute h-[628px] top-[0] w-[100%]">
                    <Column
                      className="absolute bg-cover bg-no-repeat flex flex-col items-end justify-start p-[12px] sm:p-[6px] md:p-[8px] top-[0] w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_group1.png')",
                      }}
                    >
                      <Column className="flex flex-col justify-start sm:mb-[33px] md:mb-[43px] mb-[63px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[89%]">
                        <Button
                          className="flex sm:h-[22px] md:h-[28px] h-[40px] items-center justify-center md:ml-[109px] ml-[159px] sm:ml-[84px] sm:w-[21px] md:w-[27px] w-[40px]"
                          shape="icbCircleBorder18"
                          size="smIcn"
                          variant="icbOutlineWhiteA70026"
                        >
                          <Img
                            src="images/img_frame15039.svg"
                            className="h-[24px] sm:h-[13px] md:h-[17px] flex items-center justify-center"
                            alt="Frame15039"
                          />
                        </Button>
                        <Column className="flex flex-col items-center justify-start md:mr-[18px] mr-[27px] sm:mt-[100px] md:mt-[129px] mt-[188px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[87%]">
                          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                            <Text
                              className="flex-grow text-white_A700 tracking-ls04 md:tracking-ls1 sm:tracking-ls1"
                              as="h1"
                              variant="h1"
                            >
                              Pavel Dantsev
                            ...
                            <Img
                              src="images/img_squircle.png"
                              className="sm:h-[13px] md:h-[17px] h-[24px] rounded-radius50 sm:w-[12px] md:w-[16px] w-[24px]"
                              alt="Squircle"
                            />
                          </Row>
                          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[97%]">
                            <Text
                              className="font-normal italic mt-[1px] text-white_A700 tracking-ls028 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                              as="h4"
                              variant="h4"
                            >
                              pashq.aerx
                            </Text>
                            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mb-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[47%]">
                              <Img
                                src="images/img_ellipse702.png"
                                className="md:h-[12px] h-[16px] sm:h-[9px] rounded-radius50 md:w-[11px] w-[16px] sm:w-[8px]"
                                alt="Ellipse702"
                              />
                              <Text
                                className="flex-grow font-normal sm:ml-[4px] md:ml-[5px] ml-[8px] not-italic text-white_A700 tracking-ls028 md:tracking-ls1 sm:tracking-ls1"
                                as="h4"
                                variant="h4"
                              >
                                Aura: 2k
                    ...
                    <Column className="absolute bg-gray_901 bottom-[0] flex flex-col items-center justify-start pt-[4px] rounded-bl-[0] rounded-br-[0] rounded-tl-[25px] rounded-tr-[25px] w-[100%]">
                      <Column className="flex flex-col items-center justify-start w-[100%]">
                        <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[90%]">
                          ...
                          <Column className="flex flex-col justify-start sm:mt-[4px] md:mt-[5px] mt-[8px] w-[100%]">
                            <Text
                              className="capitalize font-medium text-white_A700_4c tracking-ls024 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                              as="h5"
                              variant="h5"
                            >
                              Contacts
                        ...
                        <Column className="flex flex-col items-center justify-start mt-[12px] sm:mt-[6px] md:mt-[8px] w-[100%]">
                          <Column className="bg-gray_901 flex flex-col items-center justify-start p-[4px] rounded-bl-[0] rounded-br-[0] rounded-tl-[25px] rounded-tr-[25px] shadow-bs w-[100%]">
                            <Img
                              src="images/img_arrowup.svg"
                              className="md:h-[12px] h-[16px] sm:h-[9px] max-w-[100%] md:w-[11px] w-[16px] sm:w-[8px]"
                              alt="arrowup One"
                            />
                            <Column className="flex flex-col justify-start sm:mb-[49px] md:mb-[63px] mb-[92px] sm:mt-[4px] md:mt-[5px] mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[94%]">
                              <Text
                                className="capitalize font-medium text-white_A700_4c tracking-ls024 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                                as="h5"
                                variant="h5"
                              ...
                              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[4px] md:mt-[5px] mt-[8px] w-[100%]">
                                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[45%]">
                                    <Text
                                      className="flex-grow text-white_A700 tracking-ls032 md:tracking-ls1 sm:tracking-ls1 uppercase"
                                      as="h3"
                                      variant="h3"
                                    >
                                      12,786
                                    ...
                                    <Img
                                      ...
                                      className="flex-shrink-0 max-w-[100%] sm:mt-[2px] md:mt-[3px] mt-[5px] w-[20%]"
                                      alt="grid"
                                    />
                                  </Row>
                                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[41%]">
                                    <Text
                                      className="flex-grow text-white_A700 tracking-ls032 md:tracking-ls1 sm:tracking-ls1 uppercase"
                                      as="h3"
                                      variant="h3"
                                    ...
                                    <Img
                                      src="images/img_user_9X17.svg"
                                      className="flex-shrink-0 max-w-[100%] sm:mt-[2px] md:mt-[3px] mt-[5px] w-[28%]"
                                      alt="user"
                                    />
                                  </Row>
                                </Row>
                                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[25%]">
                                  ...
                                  <Img
                                    src="images/img_location_11X11.svg"
                                    className="flex-shrink-0 h-[11px] sm:h-[6px] md:h-[8px] max-w-[100%] w-[11px] sm:w-[5px] md:w-[7px]"
                                    alt="location"
                                  />
                                </Row>
                              </Row>
                              <Stack
                                className="bg-cover bg-no-repeat h-[48px] mt-[10px] sm:mt-[5px] md:mt-[6px] p-[12px] sm:p-[6px] md:p-[8px] relative w-[100%]"
                                style={{
                                  backgroundImage:
                              ...
                              >
                                <Img
                                  ...
                                  className="absolute h-[24px] inset-y-[0] max-w-[100%] my-[auto] right-[25%] sm:w-[12px] md:w-[16px] w-[24px]"
                                  alt="close"
                                />
                              </Stack>
                            </Column>
                  ...
                  <Column className="absolute bg-gray_901 bottom-[0] flex flex-col items-center justify-start py-[4px] rounded-bl-[0] rounded-br-[0] rounded-tl-[25px] rounded-tr-[25px] shadow-bs1 w-[100%]">
                    <Column className="flex flex-col items-center justify-start mb-[3px] w-[100%]">
                      <Img
                        src="images/img_arrowup.svg"
                        className="md:h-[12px] h-[16px] sm:h-[9px] max-w-[100%] md:w-[11px] w-[16px] sm:w-[8px]"
                        alt="arrowup Two"
                      />
                      <Column className="flex flex-col justify-start sm:mt-[4px] md:mt-[5px] mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[90%]">
                        <Text
                          className="capitalize font-medium text-white_A700_4c tracking-ls024 md:tracking-ls1 sm:tracking-ls1 w-[auto]"
                          as="h5"
                          variant="h5"
                        ...
                        <Img
                          src="images/img_group15054.svg"
                          className="max-w-[100%] sm:mt-[4px] md:mt-[5px] mt-[8px] w-[100%]"
                          alt="Group15054"
                        />
                      </Column>
                      <Line className="bg-white_A700_0c h-[1.5px] mt-[12px] sm:mt-[6px] md:mt-[8px] w-[100%]" />
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[2px] md:mt-[3px] mt-[5px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[91%]">
                        <Img
                        ...
                        <Img
                          ...
                          className="max-w-[100%] rounded-radius12 w-[30%]"
                          alt="dashboard"
                        />
                        <Img
          ...
          <Column className="flex flex-col items-center justify-start sm:px-[0] w-[100%]">
            ...
            <Column className="flex flex-col items-center justify-start mt-[12px] sm:mt-[6px] md:mt-[8px] rounded-bl-[15px] rounded-br-[15px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
              <Column className="flex flex-col items-center justify-end rounded-bl-[15px] rounded-br-[15px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                  <Stack
                    className="bg-cover bg-no-repeat h-[342px] relative rounded-radius10 w-[32%]"
                    style={{
                      backgroundImage: "url('images/img_group15197.png')",
                    }}
                  >
                    <Column className="absolute flex flex-col h-[max-content] inset-[0] justify-center m-[auto] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[86%]">
                    ...
                    <Column
                      className="absolute bg-cover bg-no-repeat flex flex-col items-center justify-start p-[12px] sm:p-[6px] md:p-[8px] rounded-radius10 w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_group15197.png')",
                      }}
                    >
